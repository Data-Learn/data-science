...
Наши каналы в **Slack**:
 ...
 У курса **ML-101** у каждого модуля есть общий канал курса и отдельные каналы для каждого модуля, где будет обсуждаться практические задания и можно попросить помощи у коллег.
