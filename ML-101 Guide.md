...
[Поддержка](https://github.com/Data-Learn/data-science/blob/main/ML-101%20Guide.md#%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%BA%D0%B0)
...
- папкa **ML-101 Modules** - содержит 3 папки, соответствующие 3м модулям этого курса: **Module 01, Module 02, Module 03**. Вы найдете там: ссылку на видео урок, дополнительные материалы (опционально) и практический кейс (выполнение которого обязательно для успешного прохождения курса и получения значков и сертификата).
