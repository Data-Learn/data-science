...
Любая серьезная IT компания, команда, hr менеджер захотят увидеть ваш **Github** перед тем как с вами разговаривать.
...
### 3. Slack 
Это месенджер, вы можете скачаеть его [тут](https://slack.com/intl/en-ca/downloads/) ; в нем мы будем общаться, задавать вопросы, обсуждать что-либо.
...
5. Критика только конструктивная.
...
Несмотря на то, что **Data Learn** еще относительно молодой проект, он уже завоевал доверие у много дата профессионалов, а это значит, студенты **Data Learn** получают самые актуальные знания, которые востребованы на отечественном и западном рынке. Требуется серьезная мотивация и целеустремленность, чтобы закончить курс, и если вы справитесь с курсом **ML-101**, то вы легко справитесь с базовым уровнем задач на позициях **Data Science Intern, Junior Data Scientist, Applied Scientist**.
