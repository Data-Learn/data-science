...
- **sql-chat** - канал посвящен вопросам `SQL`.
  ...
  У каждого курса есть свои каналы.
  
  У курса **ML-101** у каждого модуля будет отдельный канал, где будет обсуждаться домашнее задание и можно попросить помощи у коллег.
  
- **ml_module01** , **ml_module02** , **ml_module03** . 

  У курса **DE-101** эти:

- **ml_moduleXX-cohortXX** 
- **ml-moduleXX-final-project** 
