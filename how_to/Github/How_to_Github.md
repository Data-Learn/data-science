# Как создать аккаунт на Github, присоединиться к курсам Datalearn, как заполнить репозиторий, создать папки и добавить практические/домашние задания (на примере курса ML-101).
...
По той же схеме создаем папки уроков в папках других модулей.

# Шаг 15. Как загрузить практические/домашние задания.
